...
class Agent(object):
    def __init__(self, **kwargs):
        ...
        # load and save
        self.actor_load_url = os.path.dirname(os.path.realpath(__file__)) + "/global/ddpg_data/actor_model.pkl"
        self.critic_load_url = os.path.dirname(os.path.realpath(__file__)) + "/global/ddpg_data/critic_model.pkl"
        self.actor_save_url = os.path.dirname(os.path.realpath(__file__)) + "/global/ddpg_data/actor_model.pkl"
        self.critic_save_url = os.path.dirname(os.path.realpath(__file__)) + "/global/ddpg_data/critic_model.pkl"
