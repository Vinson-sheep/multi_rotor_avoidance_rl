...
def save():
    ...
    save_file = open(os.path.dirname(os.path.realpath(__file__)) + '/ddpg_data/global/temp_t.bin',"wb")
...
def load():
    ...
    load_file = open(os.path.dirname(os.path.realpath(__file__)) + '/ddpg_data/global/temp_t.bin',"rb")
